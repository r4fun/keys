...
The goal of `{keys}` is to add hotkeys to shiny applications using [`mousetrap.js`](https://github.com/ccampbell/mousetrap). A demonstration of the package can be found [here](https://r4fun.dev/shiny/keys-app/).
